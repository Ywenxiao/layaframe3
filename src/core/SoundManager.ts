...
export default class SoundManager {
    ...
    // public static get uo(): SoundManager {     return SoundManager.getInst();
    // }
    ...
    private init(): void {
        //音效自定义目录
        let replaceLocal = "cdn/sounds/",
            replaceCdn = "cdn/sounds/";
        ...
        if (
            apk.getItem("op_sound_effect") == null ||
            apk.getItem("op_sound_effect") == ""
        ) {
        ...
        if (
            apk.getItem("op_sound_back") == null ||
            apk.getItem("op_sound_back") == ""
        ) {
